...
robocopy "\\hsd.local\student\HHS\Shared\Video Production\Public Desktop Win7 64bit\CS5" "C:\Public\Desktop\Data Files" /e

mkdir "C:\Data Files"
icacls "C:\Data Files" /inheritance:r /grant:r "administrators":(OI)(CI)R /grant:r "Domain Users":(OI)(CI)F /grant:r "SYSTEM":(OI)(CI)F
robocopy "\\hsd.local\student\HHS\Shared\Video Production\Public Desktop Win7 64bit\CS5" "C:\Data Files" /e
